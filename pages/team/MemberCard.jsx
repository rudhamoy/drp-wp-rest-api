    ...
    return (
        <>
            <div className="bg-[#dddddd] p-4 w-[16rem] h-[25rem] flex flex-col items-center relative">
                ...
                <div onMouseEnter={() => setZoom(true)} onMouseOut={() => setZoom(false)} className={` bg-gray-300  ${zoom ? " absolute top-0 h-[30rem]  w-[30rem] z-[2] cursor-pointer transition-all duration-500" : "overflow-hidden rounded-[100%] h-[7rem]  w-[7rem]"}`}>
